...
exports.TRUST_BADGES = exports.NAV_FEATURES = exports.PLANS = exports.BRAND = void 0;
...
exports.BRAND = {
    ...
    description: "Eagle gives owners and managers real-time work visibility through screenshots, live screen view, work replay, app usage, idle time, and productivity reports — so they can manage with facts, not assumptions.",
...
exports.PLANS = {
    [enums_1.PlanTier.BASIC]: {
        tier: enums_1.PlanTier.BASIC,
        name: "Basic",
    ...
    [enums_1.PlanTier.PROFESSIONAL]: {
        tier: enums_1.PlanTier.PROFESSIONAL,
        name: "Professional",
    ...
    [enums_1.PlanTier.BUSINESS]: {
        tier: enums_1.PlanTier.BUSINESS,
        name: "Business",
